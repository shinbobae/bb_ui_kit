...
export const black50 = '#E8E9E9';
export const black100 = '#D1D2D4';
export const black200 = '#BABCBE';
export const black300 = '#A3A5A9';
export const black400 = '#8C8F93';
export const black500 = '#74787D';
export const black600 = '#5D6268';
export const black700 = '#464B52';
export const black800 = '#2F353D';
export const black900 = '#181e27';
...
export const green100 = '#dbf3df';
export const green200 = '#c7edce';
...
export const mandarin100 = '#fdf3e4';
...
export const yellow50 = '#fffeee';
export const yellow100 = '#fffde2';
export const yellow200 = '#fff7bd';
export const yellow300 = '#ffef94';
export const yellow400 = '#fde266';
export const yellow500 = '#fdd335';
